...
internal class EditorFeature(
    ...
    scope = scope,
    reducer = reducer,
    EditorCommand.InitializeCaret,
    EditorCommand.InitializeHighlighting,
    EditorCommand.InitializeOccurrences,
    EditorCommand.InitializeSelection,
    EditorCommand.InitializeTextSnapshot
)
...
sealed interface SyntaxToken {
    ...
    data class Region(override val range: TextRange, override val type: Type) : SyntaxToken

    data class Atom(override val range: TextRange, override val type: Type, val text: String) : SyntaxToken
}